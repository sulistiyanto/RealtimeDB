...
import com.kampus.merdeka.realtimedb.databinding.FragmentFirstBinding
...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = TireListAdapter(mutableListOf()) { user ->
        ...
        firebaseDatabaseHelper.readUsers { list ->
